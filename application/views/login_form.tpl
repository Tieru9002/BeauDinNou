<section id="login">
                ...
                <form action="" method="post" id="log">
    				<input class="user_log" id="email" type="text" name="email" class="login" placeholder="Adresa de email" value="">
    				<input class="user_log" id="password"type="password" name="pass" class="login" placeholder="Parola" value="" onclick="this.value='';">    
					<!--
					onclick="this.value='';"
    				<input type="hidden" name="login" value="success">
    				<input type="submit" value="login"> -->
					</br>
					<input type="" name="Intra in cont" class="button" id="button1"  value="Intra in cont"> 
